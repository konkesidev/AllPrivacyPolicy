...
Kerahasian Informasi Pribadi adalah hal yang terpenting bagi PT Ruang Inter Koneksi ("Kami"). Kami berkomitmen untuk melindungi dan menghormati privasi pengguna ("Anda") saat mengakses dan menggunakan aplikasi, situs web (www.konekita.com) dan situs web lain yang Kami kelola, fitur, teknologi, konten dan produk yang Kami sediakan (selanjutnya, secara bersama-sama disebut sebagai "Platform").
...
2. **Informasi yang Kami kumpulkan**. Untuk setiap kunjungan Anda ke Platform Kami, Kami dapat mengumpulkan informasi berikut secara otomatis:
  ...
  1. Data nilai Anda, termasuk namun tidak terbatas pada hasil ujian Anda yang diperoleh melalui Platform, serta data akademis lain.
...
c. Penyedia analisis dan mesin pencari yang membantu Kami untuk memperbaiki dan meningkatkan optimalisasi Platform Kami.
...
**H. PERUBAHAN DALAM KEBIJAKAN PRIVASI**
...
Untuk menghubungi kami, silakan kirim surat elektronik ke **ask@konekita.com**
